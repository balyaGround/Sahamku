        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col judul">
              ...
              <h2 className="mt-5 text-white text-center">SISTEM PENDUKUNG KEPUTUSAN PEMILIHAN SAHAM BLUE CHIP UNTUK INVESTOR PEMULA DENGAN MENGGUNAKAN METODE FUZZY TRIANGULAR </h2>
            </div>
          </div>
        </div>
      </nav>
